...
//Thuộc tính flex-shrink chỉ định cách mục sẽ co lại so với phần còn lại của các mục linh hoạt bên trong cùng một vùng chứa.
// Lưu ý: Nếu phần tử không phải là một mục linh hoạt, thuộc tính flex-shrink không có tác dụng.